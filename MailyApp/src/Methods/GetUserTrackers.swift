...
internal func GetUserTrackers(token: String, indexEmail: IndexEmail, page: Int, completion: @escaping (GetUserTrackersResponse) -> Void) {
    apiMethod(
        apiMethod: HTTPMethod.GET,
        apiEndpoint: "\(ApiEndpoints.ServerUrl)/\(ApiEndpoints.UserTrackers)/\(indexEmail.rawValue)/\(page)",
        auth: true,
        token: token,
...
func complete(result: ApiResponse, error: Optional<Error>) -> GetUserTrackersResponse {
